...
CREATE TABLE "habits" (
	...
	"color" text DEFAULT '#005237' NOT NULL,
...
ALTER TABLE "alarms" ADD CONSTRAINT "alarms_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "habit_date_idx" ON "habit_logs" USING btree ("habit_id","date");--> statement-breakpoint
CREATE UNIQUE INDEX "user_date_idx" ON "journal_entries" USING btree ("user_id","date");